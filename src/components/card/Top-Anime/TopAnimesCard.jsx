...
const TopAnimesCard = ({ topAnimes }) => {
  ...
  // return (
  //   <>
  //     <li className="relative w-[150px] select-none cursor-pointer border">
  //       <div className="">
  //         {/* img */}
  ...
  //           <h2 className="text-white text-sm font-semibold leading-normal line-clamp-2">
  //             {title_english || title}
  //           </h2>
